...
export default function Home() {
	return (
		<div className="min-h-screen bg-gray-50 py-6 flex flex-col justify-center relative overflow-hidden sm:py-12">
			<img alt className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 max-w-none" src="https://play.tailwindcss.com/img/beams.jpg" width={1308} />
			...
			<div className="relative px-6 pt-10 pb-8 bg-white shadow-xl ring-1 ring-gray-900/5 sm:max-w-lg sm:mx-auto sm:rounded-lg sm:px-10">
				<div className="max-w-md mx-auto">
					<img alt="Tailwind Play" className="h-6" src="https://play.tailwindcss.com/img/logo.svg" />
					<div className="divide-y divide-gray-300/50">
						...
						<div className="pt-8 text-base leading-7 font-semibold">
							...
							<p>
								<a className="text-sky-500 hover:text-sky-600" href="https://tailwindcss.com/docs">
									Read the docs →
								</a>
							</p>
						</div>
